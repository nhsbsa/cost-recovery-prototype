...
router.post('/request-new-account', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/new-account-select-trust');
});
...
router.get('/new-account-select-trust', function(req, res) {
  ...
  res.render('hide-add-treatment-button/new-account-select-trust', {
    data: {
      ...req.session.data,
...
router.get('/new-account-cya', function(req, res) {
  ...
  res.render('hide-add-treatment-button/new-account-cya', {
    data: {
      ...req.session.data,
...
router.post('/new-account-cya', function(req, res) {
  ...
  res.redirect('/hide-add-treatment-button/confirmation-account-request-received');
});
...
router.post('/confirmation-account-request-received', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/sign-in');
});
...
router.post('/new-account-cancel-confirmation', function (req, res) {
  ...
  if (newAccConfirmCancellation === 'Yes') {
    ...
    res.redirect('/hide-add-treatment-button/new-account-cancel-confirmation');
  }
});
...
router.post('/sign-in-select-trust', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/home');
});
...
router.post(['/request-access-to-other-trusts','/request-access-to-other-trusts'], function( req, res ){
  ...
  // Always redirect
  res.redirect('/hide-add-treatment-button/request-access-to-other-trusts');
});
...
router.get('/request-access-to-other-trusts', function(req, res) {
  ...
  res.render('hide-add-treatment-button/request-access-to-other-trusts', {
    data: {
      ...req.session.data,
...
router.get('/cya-request-access-to-other-trusts', function(req, res) {
  ...
  res.render('hide-add-treatment-button/cya-request-access-to-other-trusts', {
    data: {
      ...req.session.data,
      selectedTrustsArray: selectedTrustsArray
    }
...
router.post('/cya-request-access-to-other-trusts', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/confirmation-trust-access-request-submitted');
});
...
router.post('/cancel-confirmation', function (req, res) {
  ...
  if (confirmCancellation === 'Yes') {
    ...
    res.redirect('/hide-add-treatment-button/cancel-confirmation');
  }
});
...
router.post('/add-treatment', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/treatment-start-date');
});
...
router.post('/treatment-start-date', (req, res) => {
  ...
  res.redirect('/hide-add-treatment-button/treatment-end-date');
});
...
router.post('/treatment-end-date', (req, res) => {
  ...
  // Redirect to the next page
  res.redirect('/hide-add-treatment-button/treatment-cost');
});
...
router.post('/treatment-cost', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/add-treatment-mini-cya');
});
...
router.post('/add-treatment-mini-cya', function (req, res) {
  ...
  if (registrationTypes.includes(entitlementType)) {
    res.redirect('/hide-add-treatment-button/entitlement-registration-country');
  } else if (entitlementType === 'Malta Quota') {
    res.redirect('/hide-add-treatment-button/malta-quota-number');
  }
...
router.post('/entitlement-registration-country', function (req, res) {
  ...
  if (entitlementType === 'EHIC') {
    res.redirect('/hide-add-treatment-button/ehic-search-for-person');
  } else if (entitlementType === 'PRC') {
    res.redirect('/hide-add-treatment-button/prc-search-for-person');
  } else if (entitlementType === 'S2/E112') {
    res.redirect('/hide-add-treatment-button/s2-search-for-person');
  } else if (entitlementType === 'Non-EU Reciprocal Healthcare') {
    res.redirect('/hide-add-treatment-button/non-eu-enter-patient-details');
  };
});
...
router.post('/enter-malta-quota-number', function (req, res) {
  ...
  // Redirect to check your answers
  res.redirect('/hide-add-treatment-button/search-for-person');
});
...
router.post('/ehic-search-for-person', function (req, res) {
  ...
  // Redirect to check your answers
  res.redirect('/hide-add-treatment-button/ehic-search-for-person-results');
});
...
router.post('/ehic-view-person-record-johndoe', function (req, res) {
  ...
  // Redirect to search for institution results page
  res.redirect('/hide-add-treatment-button/upload-existing-ehic');
});
...
router.post('/upload-existing-ehic', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/review-uploaded-ehic');
});
...
router.post('/review-uploaded-ehic', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/ehic-confirm-additional-costs');
});
...
router.post('/ehic-confirm-additional-costs', function (req, res) {
  ...
  if (ehicAdditionalCostsCorrect === 'Yes') {
    res.redirect('/hide-add-treatment-button/ehic-known-address');
  } else {
    res.redirect('/hide-add-treatment-button/ehic-new-total-treatment-cost');
  }
...
router.post('/ehic-new-total-treatment-cost', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/ehic-adjusted-additional-costs');
});
...
router.post('/add-person-ehic', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/ehic-search-for-institution');
});
...
router.post('/ehic-search-for-institution', function (req, res) {
  ...
  // Redirect to search for institution results page
  res.redirect('/hide-add-treatment-button/ehic-search-for-institution-results#result');
});
...
router.post('/ehic-known-address', function (req, res) {
  ...
  if (ehicKnowAddress === 'Yes') {
    res.redirect('/hide-add-treatment-button/ehic-enter-address');
  } else {
    res.redirect('/hide-add-treatment-button/new-ehic-details-cya');
  }
});
...
router.post('/new-ehic-details-cya', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/confirmation-ehic-treatment-processed');
});
...
router.post('/confirmation-ehic-treatment-processed', function (req, res) {
  ...
  if (ehicAddAnotherTreatmentSamePerson === 'For John Doe') {
    res.redirect('/hide-add-treatment-button/add-treatment-johndoe');
  } else {
    res.redirect('/hide-add-treatment-button/add-treatment');
  }
});
...
router.post('/prc-search-for-person', function (req, res) {
  ...
  // Redirect to check your answers
  res.redirect('/hide-add-treatment-button/prc-search-for-person-results');
});
...
router.post('/prc-view-person-record-johndoe', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/upload-existing-prc');
});
...
router.post('/upload-existing-prc', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/review-uploaded-prc');
});
...
router.post('/review-uploaded-prc', function (req, res) {
  ...
  // Redirect to 'Do you know the patient's address?' screen
  res.redirect('/hide-add-treatment-button/prc-known-address');
});
...
router.post('/prc-known-address', function (req, res) {
  ...
  if (prcKnowAddress === 'Yes') {
    res.redirect('/hide-add-treatment-button/prc-enter-address');
  } else {
    res.redirect('/hide-add-treatment-button/prc-details-cya');
  }
});
...
router.post('/prc-details-cya', function (req, res) {
  ...
  // Redirect to confirmation treatment form processed screen
  res.redirect('/hide-add-treatment-button/confirmation-prc-treatment-processed');
});
...
router.post('/add-person-prc', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/prc-search-for-institution-id');
});
...
router.post('/prc-search-for-institution-id', function (req, res) {
  ...
  // Redirect to search for institution results page
  res.redirect('/hide-add-treatment-button/prc-search-for-institution-id-results#result');
});
...
router.post('/prc-enter-address', function (req, res) {
  ...
  // Redirect to search for institution results page
  res.redirect('/hide-add-treatment-button/new-prc-details-cya');
});
...
router.post('/s2-search-for-person', function (req, res) {
  ...
  // Redirect to check your answers
  res.redirect('/hide-add-treatment-button/s2-search-for-person-results');
});
...
router.post('/copy-of-s2', function (req, res) {
  ...
  if (s2HaveCopy === 'Yes') {
    res.redirect('/hide-add-treatment-button/add-person-s2');
  } else {
    res.redirect('/hide-add-treatment-button/s2-contact-cr');
  }
});
...
router.post('/add-person-s2', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/s2-search-for-institution-id');
});
...
router.post('/s2-search-for-institution-id', function (req, res) {
  ...
  // Redirect to search for institution results page
  res.redirect('/hide-add-treatment-button/s2-search-for-institution-id-results#result');
});
...
router.post('/s2-enter-address', function (req, res) {
  ...
  // Redirect to search for institution results page
  res.redirect('/hide-add-treatment-button/new-s2-details-cya');
});
...
router.post('/new-s2-details-cya', function (req, res) {
  ...
  // Redirect to confirmation treatment form processed screen
  res.redirect('/hide-add-treatment-button/confirmation-s2-treatment-processed');
});
...
router.post('/non-eu-enter-patient-details', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/new-non-eu-details-cya');
});
...
router.post('/new-non-eu-details-cya', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/confirmation-non-eu-treatment-processed');
});
...
router.post('/search-person', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/search-person-results');
});
...
router.post('/search-person-by-treatment-id', function (req, res) {
  ...
  res.redirect('/hide-add-treatment-button/search-person-by-treatment-id-results');
});

// View EHIC details
router.post('/view-ehic-details-johndoe', function (req, res) {
  // Redirect to treatment record
  res.redirect('/hide-add-treatment-button/treatment-record-unable-to-add-treatment');
});
